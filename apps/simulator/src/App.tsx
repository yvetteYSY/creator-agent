    ...
    <div className="app-shell" data-revision={revision}>
      <header className="topbar">
        ...
        <div className="topbar-actions">
          <span className="cost-label"><LockKeyhole aria-hidden="true" /> Local · $0 AI spend</span>
    ...
    <div className="preview-workspace">
      ...
      <section className="phone-stage">
        <div className="phone" aria-label="Mobile audience chat preview">
          ...
          <div className="disclosure"><Bot /> Deterministic local demo · no AI/API calls or token charges.</div>
          <div className="messages" aria-live="polite">
            {conversation.messages.length === 0 ? (
              <EmptyChat greeting={agent.greeting} onPrompt={send} />
            ) : (
          ...
          <form className="composer" onSubmit={(event) => { event.preventDefault(); send(question); }}>
            <input aria-label="Message" value={question} onChange={(event) => setQuestion(event.target.value)} placeholder="Ask about Ari's content…" />
